...
Create a complex number with only a real part. (Input: x = 5)
...
### Hint 1
The `complex()` function can take one or two arguments.

#### Penalty
20 Points

### Hint 2
If only one argument is given, the imaginary part is assumed to be 0.
