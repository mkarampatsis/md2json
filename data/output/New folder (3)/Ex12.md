...
Extract all numbers (integer or decimal) from a given string. (Input: 'The price is $9.99')

Expected output:
```
Numbers found: [list of numbers found]
```
...
input_string = 'The price is $9.99'
...
### Hint 2
Use the `findall()` function to find all numbers in the string, accounting for integers and decimals.
