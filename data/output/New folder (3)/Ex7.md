...
Check if a given string contains only letters (uppercase and lowercase). (Input: 'AbCDefg')

In case it contains only letters print 'String contains only letters.' else print 'String contains non-letter characters.'.
...
### Hint 2
Use the `match()` function to check if the pattern matches the entire string.
