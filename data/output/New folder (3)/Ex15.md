...
Check if a given string contains repeated consecutive characters. (Input: 'Hello')

Print 'String contains repeated consecutive characters.' if true else 'String does not contain repeated consecutive characters.' if false.
...
if pattern.search(input_string):
	print('String contains repeated consecutive characters.')
else:
	print('String does not contain repeated consecutive characters.')
```

## Output Data
type=oneline
String contains repeated consecutive characters.
...
### Hint 2
Use backreferences to capture and match repeated consecutive characters.
