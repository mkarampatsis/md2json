...
Check if a given string is a valid Social Security Number (SSN) in the format 'XXX-XX-XXXX'. If valid print "Valid SSN." else "Invalid SSN.". (Input: '123-45-6789')
...
### Hint 2
Use the `match()` function to check if the pattern matches the entire SSN.
