...
Split a given string into sentences. (Input: 'Hello. How are you? Goodbye.')
...
input_string = 'Hello. How are you? Goodbye.'
...
### Hint 2
Pass the appropriate regex pattern to split the string into sentences.
