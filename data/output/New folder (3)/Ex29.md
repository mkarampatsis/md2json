...
Check if a given string contains any special characters (non-alphanumeric). If it contains print 'String contains special characters.' else 'String does not contain special characters.'. (Input: 'Hello, world!')
