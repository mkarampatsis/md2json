...
Check if a given string contains any punctuation characters. (Input: 'Hello, world!')

Print 'String contains punctuation characters.' if true else 'String does not contain punctuation characters.' if false.
...
if re.search(r'[%s]' % re.escape(string.punctuation), input_string):
    print('String contains punctuation characters.')
else:
    print('String does not contain punctuation characters.')

```

## Output Data
type=oneline
String contains punctuation characters.
...
### Hint 2
Use a character class or character category to match punctuation characters. You can use the 'string.punctuation' from 'import string'.
