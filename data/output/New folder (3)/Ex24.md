...
Check if a given string starts with 'The'. (Input: 'The quick brown fox')

If it starts print "String starts with 'The'." else "String does not start with 'The'.".
## Code
```py3
import re
...
if pattern.search(input_string):
	...
	print('String does not start with \'The\'.')
```
...
### Hint 2
Use the `search()` function to find the pattern at the beginning of the string.
