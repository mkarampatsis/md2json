...
Count the number of occurrences of 'apple' in a given string. (Input: 'I have an apple, an orange, and an apple.')
...
input_string = 'I have an apple, an orange, and an apple.'

pattern = re.compile(r'apple')
occurrences = len(pattern.findall(input_string))
