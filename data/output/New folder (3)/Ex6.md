...
Replace all occurrences of 'red' with 'blue' in a given string. (Input: 'The red car and the red house')
...
input_string = 'The red car and the red house'

pattern = re.compile(r'red')
result = pattern.sub('blue', input_string)
print('String after replacement:', result)
```

## Output Data
type=oneline
String after replacement: 'The blue car and the blue house'
