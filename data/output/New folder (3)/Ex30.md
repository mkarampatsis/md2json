...
Check if a given string is a valid time in the format 'HH:MM' (24-hour format). If valid print 'Valid time.' else 'Invalid time.'. (Input: '13:45')
...
### Hint 2
Use the `match()` function to check if the pattern matches the entire time.
