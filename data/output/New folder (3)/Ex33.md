...
Extract all capitalized words from a given string. (Input: 'Hello World! This Is a Test.')

Expected output:
```
Capitalized words found: [list of capitalized words]
```
...
capitalized_words = pattern.findall(input_string)
print('Capitalized words found:', capitalized_words)
```

## Output Data
type=oneline
Capitalized words found: ['Hello', 'World', 'This', 'Is', 'Test']
...
### Hint 2
Use the `findall()` function to find all capitalized words in the string.
