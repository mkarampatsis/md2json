...
Check if a given string ends with 'ing'. (Input: 'Walking')

In case it ends with 'ing' then print "String ends with 'ing'." else print "String does not end with 'ing'.".

## Code
```py3
import re

input_string = 'Walking'
...
### Hint 2
Use the `search()` function to find the pattern at the end of the string.
