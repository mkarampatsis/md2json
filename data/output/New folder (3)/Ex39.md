...
Extract all URLs from a given string. (Input: 'Visit my website at https://www.example.com or check out https://www.example.org for more information.')

The expected output is:
```
URLs found: [array of matched urls]
```
...
input_string = 'Visit my website at https://www.example.com or check out https://www.example.org for more information.'
pattern = re.compile(r'https?://[\w.-]+\.[a-zA-Z]{2,}/?')
urls = pattern.findall(input_string)
print('URLs found:', urls)
```

## Output Data
type=oneline
URLs found: ['https://www.example.com', 'https://www.example.org']
...
### Hint 2
Use the `findall()` function to find all URLs in the string.
