...
Remove all consecutive duplicate words from a given string. (Input: 'The cat cat sat sat on on the the mat mat.')

Expected output:
```
[renewed string without duplicates]
```
...
input_string = 'The cat cat sat sat on on the the mat mat.'
...
## Output Data
type=oneline
String after removal: 'The cat sat on the mat.'
...
### Hint 2
Use backreferences and the `sub()` function to remove consecutive duplicate words.
