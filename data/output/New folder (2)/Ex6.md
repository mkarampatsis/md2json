...
Compare whether a string is greater than another string in lexicographic order. The strings are 'apple' and 'banana'. Print the result to the console using the print method.
...
### Hint 1
Use the '<' operator to compare the two strings.
