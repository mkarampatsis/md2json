...
Calculate the result of (8 >= 6) == (6 <= 9) and print it to the console using the print method. 
...
### Hint 1
Think about the result of each of the comparisons inside the parentheses separately.

#### Penalty
20 Points

### Hint 2
Use parentheses to group the comparisons correctly.
