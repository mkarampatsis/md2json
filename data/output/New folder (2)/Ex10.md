...
Check if the given value is not between 10 and 20 (inclusive) (Input: 15)
...
### Hint 1
Use the less than (<=) and greater than or equal to (>=) operators to check if the value is outside the range of 10 to 20.
