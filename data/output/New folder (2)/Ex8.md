...
Check if the given age is greater than or equal to 18. If it is, print True, otherwise False (Input: 20)
...
### Hint 1
Use greater than or equal to operator (>=) to check if the age is greater than or equal to 18.
