...
Check if the given value is between 10 and 20 (exclusive). If it is, print True, otherwise False (Input: 15)
...
### Hint 1
Use the logical AND operator (and) to check if the value is greater than 10 and less than 20.
