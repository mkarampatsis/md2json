...
Check if the given number is even or not. If it is even, print True, otherwise False (Input: 4)
...
### Hint 2
If the remainder is zero after dividing the number by 2, then it is even.
