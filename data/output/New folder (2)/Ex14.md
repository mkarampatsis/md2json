...
Check if the length of 'hello' is less than or equal to the length of 'world'.
...
### Hint 2
Use the '<=' operator to check if the left operand is less than or equal to the right operand.
