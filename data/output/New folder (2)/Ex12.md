...
Check if the given value is between 10 and 20 (inclusive). If it is, print True, otherwise False (Input: 15)
...
### Hint 1
Use the logical AND operator (and) to check if the value is greater than or equal to 10 and less than or equal to 20.

#### Penalty
20 Points

### Hint 2
The logical AND operator (and) returns True only if both conditions are True.
