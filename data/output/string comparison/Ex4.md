...
Compare two strings with the < operator. Use the operator in an if statement to compare the strings and if the condition is met then print 'The first string is less' otherwise print 'The second string is less'. (Input: string1 = 'apple', string2 = 'banana')
...
if string1 < string2:
	print('The first string is less')
else:
	print('The second string is less')
```
