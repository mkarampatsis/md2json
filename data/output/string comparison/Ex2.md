...
Compare two strings with the != operator. Use this operator as the condition of an if statement and if the condition is met then print 'The strings are not equal' otherwise print 'The strings are equal'. (Input: string1 = 'hello', string2 = 'world')
