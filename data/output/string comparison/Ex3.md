...
Compare two strings with the > operator. Use the operator as the condition in an if statement and if the condition is met then print 'The first string is greater' otherwise 'The second string is greater'. (Input: string1 = 'apple', string2 = 'banana')
