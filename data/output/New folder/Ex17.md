...
Calculate the result of the expression (15 - 7) // 3 * 2 and print it to the console using the print method. 
...
### Hint 1
Remember the order of operations: parentheses first, then integer division, then multiplication/division, then addition/subtraction.
