...
Calculate the result of the expression 8 % 3 + 2 ** 2 and print it to the console using the print method. 
...
### Hint 1
Remember the order of operations: exponentiation first, then modulus, then multiplication/division, then addition/subtraction.
