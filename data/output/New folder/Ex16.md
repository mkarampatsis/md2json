...
Calculate the result of the expression 4 ** 2 - 10 + 5 * 3 and print it to the console using the print method. 
...
### Hint 1
Remember the order of operations: exponentiation first, then multiplication/division, then addition/subtraction.
