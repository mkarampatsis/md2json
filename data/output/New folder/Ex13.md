...
Calculate the result of 9.8 multiplied by 2.5 and then floor the result.


## Code
```py3
import math
result = math.floor(9.8 * 2.5)
print(result)
```
...
### Hint 2
Use the floor method from the `math` library after the multiplication.
