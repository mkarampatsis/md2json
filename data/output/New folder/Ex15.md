...
Calculate the result of the expression (7 + 3) * 6 / 2 and print it to the console using the print method. 
...
### Hint 1
Remember the order of operations: parentheses first, then multiplication/division, then addition/subtraction.
