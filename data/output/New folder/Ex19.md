...
Calculate the result of the expression 10 / 2 * 3 - 5 + 2 and print it to the console using the print method. 
...
### Hint 1
Remember the order of operations: multiplication/division first, then addition/subtraction.
