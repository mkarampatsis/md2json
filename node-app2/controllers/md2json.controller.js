...
const readFileController = require('./readfiles.controller');

exports.getOneFile = function(req, res) {
  filename = req.params.filename;
  
  console.log("Function getOneFile,  read file " + filename);
...
exports.getAllFiles = function(req, res) {
  console.log("Function getAllFiles, read all files");

  try {
    res.json({ data: "All files" });
  } catch (err) {
    res.status(400).json({ data: err });
    console.log("Problem in reading all files", err);
  }
} 
